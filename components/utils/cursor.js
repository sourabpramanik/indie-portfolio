...
import { lerp, getMousePos, getSiblings } from "./index";
...
export default class Cursor {
  constructor(el) {
    ...
    this.cursorConfigs = {
      x: { previous: 0, current: 0, amt: 1.8 },
      y: { previous: 0, current: 0, amt: 1.8 },
    };
    this.onMouseMoveEv = () => {
  ...
  render() {
    ...
    this.Cursor.style.transform = `translate3d(${this.cursorConfigs.x.previous}px, ${this.cursorConfigs.y.previous}px, 0)`;
    // RAF
    requestAnimationFrame(() => this.render());
  }
}
